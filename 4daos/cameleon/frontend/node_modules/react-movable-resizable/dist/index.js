...
var ContextProvider = React.forwardRef(function (_a, ref) {
    ...
    var _c = React.useState({ x: 0, y: 0 }), offsets = _c[0], setOffsets = _c[1];
    var _d = React.useState(false), movableActive = _d[0], setMovableActive = _d[1];
    var _e = React.useState(false), resizbleActive = _e[0], setResizbleActive = _e[1];
    var movableRef = ref || React.useRef(null);
...
var Movable = function (_a) {
    ...
    var _g = React.useContext(Context), positions = _g.positions, setPositions = _g.setPositions, offsets = _g.offsets, setOffsets = _g.setOffsets, setMovableActive = _g.setMovableActive, movableActive = _g.movableActive, resizbleActive = _g.resizbleActive, movableRef = _g.movableRef;
...
var Resizble = function (_a) {
    ...
    var _c = React.useContext(Context), positions = _c.positions, setPositions = _c.setPositions, setOffsets = _c.setOffsets, movableActive = _c.movableActive, setResizbleActive = _c.setResizbleActive, movableRef = _c.movableRef;
    ...
    return (React.createElement(React.Fragment, null,
        reizersMap.map(function (_a) {
            ...
            return (React.createElement(ResizerStyled, { className: className, handlersColor: handlersColor, onMouseDown: onResizerMouseDown, onTouchStart: onResizerTouchStart, key: className, hideHandlers: hideHandlers }));
        }),
        children));
};

var index = React.forwardRef(function (props, ref) {
    return (React.createElement(ContextProvider, { ref: ref },
        React.createElement(Movable, __assign({}, props),
            React.createElement(Resizble, __assign({}, props)))));
});
var MovableComponent = React.forwardRef(function (props, ref) {
    return (React.createElement(ContextProvider, { ref: ref },
        React.createElement(Movable, __assign({}, props))));
});
